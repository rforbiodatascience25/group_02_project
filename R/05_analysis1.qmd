...
A PCA on just the signals from the probes is done to see if it can show a connection between the signals pre vaccine and the response to the vaccine. The PCA is done with inspiration from ["PCA tidyverse style" by Claus O. Wilke](https://clauswilke.com/blog/2020/09/07/pca-tidyverse-style/)
