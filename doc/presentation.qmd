...
![Made with draw.io](/results/FlowChart.drawio.png){width="60%"}
...
::::: columns
::: {.column width="50%"}
![From paper](/results/06_B1_plot.png)
:::

::: {.column width="50%"}
![Improved](/results/06_B2_plot.png)
:::
:::::
...
::::: columns
::: {.column width="50%"}
![Not well separated but PC2 and PC3 most separated](/results/05_1d_plot.png)
:::

::: {.column width="50%"}
![No separation](/results/05_2d_plot.png)
:::
:::::
